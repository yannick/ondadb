...
fn cf_writer_opts(
    ...
    crate::sst::WriterOptions {
        ...
        // Was a bare `4 << 10` here while `ColumnFamily::writer_opts` used the
        // constant — two spellings of one number, in the two places that had
        // to agree. Now both read the family's setting.
